...
// pub fn slot_author<P: Pair>(slot: Slot, authorities: &[AuthorityId<P>], w: u32) -> Option<&AuthorityId<P>> {
// 	if authorities.is_empty() || w == 0 {
// 		return None
// 	}

//     // Change the author every `w` aura slot.
//     let idx = (slot / w) % (authorities.len() as u64);
